 ...
 * @since v0.1
 */
public class JiraBuildNumberDependentTest extends TestBase {
	...
	public void testOnlyForJira50OrNewer() throws Exception {
		if (funcTestHelper.administration.getBuildNumber() < BN_JIRA_5) {
	...
	public void testOnlyForJira43OrNewer() throws Exception {
		if (funcTestHelper.administration.getBuildNumber() < BN_JIRA_4_3) {
			Assert.fail("Build number is less than expected!");
		}
	}
	...
	public void testOnlyForJira44OrOlder() throws Exception {
		if (funcTestHelper.administration.getBuildNumber() > BN_JIRA_4_4) {
